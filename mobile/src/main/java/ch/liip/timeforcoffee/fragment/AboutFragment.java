...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView appLink = view.findViewById(R.id.appLink);
        ...
        TextView appTwitterLink = view.findViewById(R.id.appTwitterLink);
        ...
        TextView francoisTwitter = view.findViewById(R.id.francoisTwitter);
        ...
        TextView christianTwitter = view.findViewById(R.id.christianTwitter);
        ...
        TextView janTwitter = view.findViewById(R.id.janTwitter);
        ...
        TextView cyrilTwitter = view.findViewById(R.id.cyrilTwitter);
        ...
        TextView fabioTwitter = view.findViewById(R.id.fabioTwitter);
        ...
        TextView nicolasTwitter = view.findViewById(R.id.nicolasTwitter);
        ...
        TextView lucaGithub = view.findViewById(R.id.lucaGithub);
        ...
        TextView pascalGithub = view.findViewById(R.id.pascalGithub);
        ...
        TextView sylvainGithub = view.findViewById(R.id.sylvainGithub);
